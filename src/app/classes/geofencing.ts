class CircularGeofenceRegion {
    constructor(opts: { latitude: number, longitude: number, radius?: number, axis?: number, name?: string }) {
  ...
  class SquareGeofenceRegion {
    constructor(opts: { latitude: number, longitude: number, axis?: number, name?: string }) {
      Object.assign(this, opts)
    }
